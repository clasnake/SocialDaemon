...
public class DaemonWidget extends AppWidgetProvider{
	private static final String TAG = DaemonWidget.class.getSimpleName();
	    ...
	    try {
	      if (c.moveToFirst()) { 
	        ...
	        for (int appWidgetId : appWidgetIds) { 
	          ...
	          views.setOnClickPendingIntent(R.id.daemon_icon, PendingIntent
	  ...
	  public void onReceive(Context context, Intent intent) { 
	    ...
	    if (intent.getAction().equals(UpdaterService.NEW_STATUS_INTENT)) {
	      ...
	      this.onUpdate(context, appWidgetManager, appWidgetManager
	          .getAppWidgetIds(new ComponentName(context, DaemonWidget.class)));
	    }
	  }
}
